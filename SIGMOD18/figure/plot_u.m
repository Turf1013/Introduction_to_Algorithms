...
newFIFO1       = [1199745.315, 610986.831, 410454.352, 312743.307, 255763.957];
Hybrid1        = [1163056.408, 589975.118, 399841.129, 306833.467, 251351.566];
FirstInFirstServe1 = [3496044.768, 2058576.166, 1595630.811, 1382438.306, 1092324.409];
newSJF1        = [961856.804, 494378.279, 336467.754, 267848.448, 221972.972];
...
newFIFO2       = [7.005, 6.586, 6.797, 6.505, 6.771];
Hybrid2        = [6.872, 6.755, 6.415, 6.695, 6.374];
FirstInFirstServe2 = [0.215, 0.219, 0.214, 0.263, 0.268];
newSJF2        = [6.628, 6.739, 6.575, 6.662, 6.706];
ShortestJobFirst2 = [0.275, 0.267, 0.246, 0.244, 0.223];
GreedyInsert2  = [176.615, 33.942, 13.174, 6.007, 3.000];
newFIFO3       = [403001.472, 336952.201, 410454.352, 505213.271, 553407.080];
Hybrid3        = [393518.242, 327973.674, 399841.129, 482742.143, 526426.507];
FirstInFirstServe3 = [1328677.092, 1431505.786, 1595630.811, 2139591.492, 3646936.001];
newSJF3        = [364335.614, 303784.448, 336467.754, 411593.490, 459053.878];
...
newFIFO4       = [5.294, 3.877, 6.797, 8.681, 9.194];
Hybrid4        = [5.419, 3.808, 6.415, 9.022, 9.169];
FirstInFirstServe4 = [0.001, 0.213, 0.214, 0.254, 0.394];
newSJF4        = [5.164, 4.015, 6.575, 8.838, 9.035];
ShortestJobFirst4 = [0.001, 0.216, 0.246, 0.255, 0.385];
GreedyInsert4  = [13.045, 12.839, 13.174, 13.330, 10.587];
newFIFO5       = [22620.395, 106476.368, 410454.352, 1595674.003, 3618630.702];
Hybrid5        = [22665.634, 103666.088, 399841.129, 1549868.036, 3463040.417];
FirstInFirstServe5 = [80746.103, 593482.526, 1595630.811, 5475219.376, 11050136.818];
newSJF5        = [21832.020, 97370.821, 336467.754, 1211486.912, 2556389.642];
...
newFIFO6       = [1.332, 3.349, 6.797, 13.103, 19.914];
Hybrid6        = [1.310, 3.530, 6.415, 13.392, 19.913];
FirstInFirstServe6 = [0.044, 0.126, 0.214, 0.482, 0.738];
newSJF6        = [1.295, 3.336, 6.575, 13.048, 19.668];
ShortestJobFirst6 = [0.049, 0.156, 0.246, 0.439, 0.678];
GreedyInsert6  = [0.010, 0.643, 13.174, 225.780, 776.470];
newFIFO7       = [373435.061, 361714.645, 410454.352, 300606.845, 275559.184];
Hybrid7        = [361395.236, 355497.046, 399841.129, 297456.577, 267041.169];
FirstInFirstServe7 = [1552425.756, 1537863.923, 1595630.811, 1159037.497, 1068056.252];
newSJF7        = [306075.908, 300257.176, 336467.754, 254197.462, 228681.007];
...
newFIFO8       = [6.801, 6.597, 6.797, 6.758, 6.850];
Hybrid8        = [6.784, 5.958, 6.415, 6.835, 6.817];
FirstInFirstServe8 = [0.286, 0.285, 0.214, 0.233, 0.195];
newSJF8        = [6.896, 6.671, 6.575, 6.724, 6.844];
...
plot(x1, newSJF1, '^--', 'Color', mpdc5(4, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
plot(x1, newFIFO1, 's--', 'Color', mpdc5(5, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
plot(x1, Hybrid1, 'd-', 'Color', mpdc5(6, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
...
h_legend = legend('SJF',  'FIFO', 'GreedyInsert', 'newSJF', 'newFIFO', 'Hybrid', 'Location','SouthEast');
...
plot(x2, newSJF2, '^--', 'Color', mpdc5(4, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
plot(x2, newFIFO2, 's--', 'Color', mpdc5(5, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
plot(x2, Hybrid2, 'd-', 'Color', mpdc5(6, :), 'LineWidth', linewidth, 'MarkerSize', markersize);
