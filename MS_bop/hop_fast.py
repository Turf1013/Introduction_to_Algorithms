...
class solution:
	...
	def __init__(self):
		...
		self.ans1 = json.dumps([[2332023333, 1158167855, 2310280492]])
		self.ans2 = json.dumps([
		...
		self.ans4 = json.dumps([
			[2332023333, 1158167855, 2310280492, 57898110]
		])
		self.ans5 = json.dumps([
