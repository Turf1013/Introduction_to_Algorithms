...
OPQ_Extended2  = [0.010, 0.007, 0.009, 0.010, 0.010];
Baseline2      = 5 * [6.887, 7.201, 7.214, 7.238, 7.164];
Greedy2        = [1.755, 2.207, 2.642, 3.113, 3.283];
...
OPQ_Extended4  = [0.006, 0.008, 0.009, 0.010, 0.009];
Baseline4      = 5 * [7.375, 7.222, 7.204, 7.149, 7.055];
Greedy4        = [3.109, 3.337, 3.131, 3.185, 2.930];
...
OPQ_Extended6  = [0.010, 0.009, 0.010, 0.010, 0.010];
Baseline6      = 5 * [6.535, 6.780, 7.169, 7.193, 7.304];
Greedy6        = [2.550, 2.600, 2.972, 3.317, 4.063];
...
OPQ_Extended8  = [0.010, 0.010, 0.011, 0.011, 0.009];
