...
Greedy2        = [0.184, 0.362, 0.419, 0.356, 0.365];
Greedy4        = [0.780, 0.686, 0.639, 0.611, 0.618, 0.516, 0.362, 0.351, 0.294, 0.214, 0.161];
Greedy6        = [0.362, 1.369, 3.053, 8.524, 19.393, 36.614];
