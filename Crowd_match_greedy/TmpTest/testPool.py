...
def testPool():
	...
	dataFilePath = "/home/server/zyx/tmp/gMission_data"
	execFilePath = "/home/server/zyx/TmpTest"
	logPrefix = "/home/server/zyx/tmp/gMission_log"

	dataNameList = filterDataSet(dataFilePath)
	print execNameList[-1:]
	print dataNameList
	...
	for dataFileName in dataNameList:
		...
		for execName in execNameList[-1:]:
