...
\subsection{String-matching automata}
	...
	\begin{proof}
		...
		\begin{align*}
			...
			v = Border(ua)					&\Rightarrow	v \in Pref(ua), v \in Suff(ua)	\\
			v \in Suff(ua) 					&\Rightarrow 	vb \in Suff(uab)	\\
			w' = Border(uab) 				&\Rightarrow 	w' \in Pref(uab), w' \in Suff(uab)	\\
			...
			w = Border(vb), w' \in border(vb) &\Rightarrow 	|w| \ge |w'|	\\
